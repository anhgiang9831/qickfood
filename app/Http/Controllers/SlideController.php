...
class SlideController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('slides.list')->with('success', 'Thêm slide thành công');
    }
...
//            $file->move('uploads/rooms', $file_name);
        ...
        $slide->save();
        return redirect()->route('slides.list')->with('success', 'Sửa slide thành công');
    }
    ...
    public function getdel($id)
    {
        ...
        unlink($path);
        $slide->delete();
        return redirect()->route('slides.list')->with('success', 'Xóa slide thành công');
    }
}
